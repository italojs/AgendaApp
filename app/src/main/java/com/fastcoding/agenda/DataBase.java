...
public class DataBase extends SQLiteOpenHelper {
    ...
    public DataBase(Context context) {       //construtor da classe SQLiteOpenHelper
    ...
    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) { // atualiza as tabelas
